...
if ($_POST['lee']<>'') {
      ...
      $mostrar = iconv("ISO-8859-1","UTF-8",dado_Id($bd,$ID,"alumno","tb_alumno","idalumno"))." (".dado_Id($bd,$ID,"unidad","tb_alumno","idalumno").")";
      // Borrado de ese dato
      $Sql='DELETE FROM tb_alumno WHERE idalumno="'.$ID.'"';
      $link=Conectarse($bd);
