...
<div id="menu">
  ...
  if ($_SESSION['administracion']>=1) { // para los profesores ?>
	 <!-- <li id="licuatro"><a href="#" onmouseover="javascript: ocultar(); toogle('licuatro','menu5',event)">Notas</a></li> ANULADO --> 
  <?php } 

  if ($_SESSION['administracion']>=2 && $_SESSION['tutorada']==1) { // para el tutor ?>
	 <li id="lidos"><a href="#" onmouseover="javascript: ocultar(); toogle('lidos','menu3',event)">Tutoría</a></li>
  <?php } 
  if ($_SESSION['administracion']==3) { // para el administrador ?>
         <li id="liuno"><a href="#" onmouseover="javascript: ocultar(); toogle('liuno','menu2',event)">Edición</a></li>
  <?php } ?>
...
<div id="pequenno">
   ...
   if ($_SESSION['administracion']==3) {        
       ...
       $escribeestado="Sesión de administración (".$profadministrador."). Edito como \"".$profsimulado."\""; 
   } else if ($_SESSION['administracion']<3 && $_SESSION['administracion']>0) { 
       $escribeestado="Sesión como profesor/a. Profesor/a: ".$profsimulado; 
   } else {
       $escribeestado="Sesión no inicializada. Vuelve a la pág. ÍNDICE si no te encuentras en ella.";
   }
...
left: 500px; top: 150px; height: auto; z-index: 12; background-color: transparent; border: 2px none black;"> --> 
	...
	<ul>
		...
		<li><a href="./edicionlistaevaluaciones.php">Editar períodos de evaluación</a></li>
...
height: auto; z-index: 13; background-color: transparent; border: 2px none black;">
	...
	<ul>
		...
		<li><a href="./guardardatosinicialestutoria.php">Filtro por evaluación</a></li>
		<li><a href="./veruno.php?boton=Primero">Datos por alumno/a, dada evaluación. Todas las asignaciones.</a></li>
		<li><a href="./verdos.php?boton=Primero">Datos por asignación (materia-profesor/a), dada evaluación. Todos los alumnos/as.</a></li>
		<li><a href="./vertres.php?boton=Primero">Por item, dada evaluación. Todos los alumnos/as y profesores.</a></li>
		<li><a href="./resumenes.php">Tablas Resumen</a></li>
                <li><a href="./emailaviso.php">Enviar email de aviso a los profesores/as de mi tutoría</a></li>
                <li><a href="./veranotaciones.php">Anotaciones en mi tutoría</a></li>
	</ul>'
;
        } ?>
...
height: auto; z-index: 13; background-color: transparent; border: 2px none black;">
        ...
        echo '
	<ul>
		<li><a href="./guardarasignaciones.php">Mis asignaciones y mi evaluación</a></li>
		...
		<li><a href="./guardardatosdos.php?boton=Primero">Guarda datos de una clase (formulario nuevo)</a></li>
                <li><a href="./opiniongeneral.php">Opinión general de una asignación (profesor-materia-curso o cursos)</a></li> 
		<li><a href="./guardardatosprofesor.php">Mis datos (cambio contraseña y correo electrónico)</a></li>  
