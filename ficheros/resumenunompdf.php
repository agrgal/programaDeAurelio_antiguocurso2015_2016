...
$clave=0;
   foreach ($itemsobtenidos as $it) {
	   ...
	   // $datostabla[$encontrar][$j+1]=1;
           ...
           $datostabla[$encontrar][$j+1]=2*$items['positivo'][$encontrar]-1; // le asigna un -1 si es un dato negativo y un 1 si es positivo...
           // los datos que no encuentre son ceros...
       }
   } // fin del foreach
...
$mpdf->Output('../ficheros/resumen.pdf','F');
// $path='../temporal/A.pdf';
// $mpdf->Output($path,'F');
header("Location: ../ficheros/descargaficheropdf.php?fichero=resumen.pdf");
exit;
